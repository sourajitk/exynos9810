...
LIBFDT_SOURCE="Makefile.libfdt fdt.h libfdt_env.h libfdt.h libfdt_internal.h fdt_addresses.c fdt_check.c fdt_overlay.c fdt_rw.c fdt_sw.c fdt.c fdt_empty_tree.c fdt_ro.c fdt_strerror.c fdt_wip.c"
